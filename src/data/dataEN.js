const dataEN = [
  ...
  },
  {
    ...
    description: [
      ...
      {
        regular:
          "A while back, I decided to part ways with my career as a translator and shift my focus from natural to programming languages.",
      },
      {
      ...
      {
        regular:
          "I enjoy exploring the intersection of techology, linguistics and language learning in my spare time.",
      },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        description:
          "Classic board game reimagined as a pure JavaScript web page.",
      ...
      },
      {
        name: "Paved",
        description:
          "App for sharing curated learning paths. Collaboration project.",
        tools: "React, Material-UI, Node.js, Express, MongoDB",
        links: {
